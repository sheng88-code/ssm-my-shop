                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <button type="button" class="btn btn-default btn-sm" onclick="App.deleMutil('/user/delete')"><i class="fa fa-trash-o"></i>删除</button>&nbsp;&nbsp;&nbsp;
                            ...
                            <button type="button" class="btn btn-sm btn-primary" onclick="$('.box-info-search').css('display')=='none'?$('.box-info-search').show('fast'):$('.box-info-search').hide('fast')"><i class="fa fa-search-plus"></i>搜索</button>
                        </div>
                        <!-- /.box-header -->
...
<script>
    ...
    $(function () {
        var columns=[
            ...
            {
                "data":function (row,type,val,meta) {
                    return DateUtils.formt(row.updated,"yyyy-MM-dd hh:mm:ss");
                }
            },
            {
                "data":function (row,type,val,meta) {
                    ...
                    return  '<button type="button" class="btn btn-default btn-sm" onclick=" return App.showDetail(\''+detailUrl+'\');"><i class="fa fa-search"></i>查看</button>&nbsp;&nbsp;&nbsp;'+
                        '<a href="/user/form?id='+row.id+'" type="button" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>编辑</a>&nbsp;&nbsp;&nbsp;'+
                        '<button type="button" class="btn btn-danger btn-sm" onclick="App.deleteSingle(\''+deleteUrl+'\',\''+row.id+'\')"><i class="fa fa-trash-o"></i>删除</button>';
                }
            }
        ];
