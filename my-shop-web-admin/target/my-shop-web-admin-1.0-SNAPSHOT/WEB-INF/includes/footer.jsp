...
<!-- jQuery UI 1.11.4 -->
<script src="${pageContext.request.contextPath}/static/assets/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<script src="${pageContext.request.contextPath}/static/assets/plugins/jQuery-validation/jquery.validate.min.js"></script>
<!--自定义规则-->
<script src="${pageContext.request.contextPath}/static/assets/plugins/jQuery-validation/additional-methods.min.js"></script>
<!--国际化：中文-->
<script src="${pageContext.request.contextPath}/static/assets/plugins/jQuery-validation/localization/messages_zh.min.js"></script>
<!-- FastClick -->
...
<!--datatime-->
<script src="${pageContext.request.contextPath}/static/assets/app/dateutils.js"></script>
