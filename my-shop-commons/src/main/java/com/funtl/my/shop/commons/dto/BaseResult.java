...
public class BaseResult implements Serializable {
    ...
    public static BaseResult success(String message,Object data){ return BaseResult.createResult(STATUS_SUCCESS,message,data);}
    ...
    public static BaseResult fail(String message,Object data){ return BaseResult.createResult(STATUS_FAIL,message,data);}
